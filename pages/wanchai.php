...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Wan Chai District
                            <div id="test"></div>
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
    ...
    ?>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="hkislandtable">
                                    ...
                                    <tbody id="table">
                                        ...
                                        //    }
                                            ...
                                            // $findate = array('Capture_Date' =>new MongoRegex('/^image/s'));
                                                ...
                                                for($x=0;$x< count($condition);$x++){
                                                    for($z=0; $z<count($roadtype);$z++){
                                                        for($i = 0 ; $i < count($data['Speed_List']['HK_Region'][$condition[$x]][$roadtype[$z]]); $i++){
                                                            ...
                                                            //echo "<tr><td>".$data['Speed_List']['ST_Region'][$condition[$x]][$roadtype[$z]][$i]['Traffic_Speed']."</td>";
                                                            $res = findAllLinkIDInWanChai();
                                                            
                                                            foreach($res as $wanchai){
                                                            
                                                                if($wanchai['Link_ID']==$data['Speed_List']['HK_Region'][$condition[$x]][$roadtype[$z]][$i]['Link_ID']){
                                                                    $lid =$data['Speed_List']['HK_Region'][$condition[$x]][$roadtype[$z]][$i]['Link_ID'];
                                                                   
                                                                    echo "<td>".$condition[$x]."</td><td>".$data['Speed_List']['HK_Region'][$condition[$x]][$roadtype[$z]][$i]['Traffic_Speed']."</td>";
                                                                    echo "<td>". $wanchai['Street_Number']."</td>";
                                                                    echo "<td>".$roadtype[$z]."</td>";
                                                                    echo "<td>"."<label id=".$lid." value = ".$wanchai['Street_Name'].">".$wanchai['Street_Name']."</label>"."</div>"."</td>";
            ...
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> Wan Chai Traffic Condition
                        <div class="pull-right">
                        </div>
                    </div>
                    <!-- /.panel-heading -->
    ...
    <script src="../data/linechart_wanchi.js"></script>
