						...
						<form action="addAccident.php" method="POST" role="form">
							<div class="form-group">
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <lable><b>Latitude</b></lable>
                                        <input type="text" type="text" class="form-control" disabled="true" name="latitude" id="lat" readonly/>
                                    </div>
                                    <div class="col-lg-2">
                                        <lable><b>Longitude</b></lable>
                                        <input type="text" type="text" class="form-control" disabled="true" name="longitude" id="lng" readonly/>
                                    </div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-2">
										...
										<input type="datetime-local" class="form-control" value="<?= date('Y-m-d').'T'.date('H:i'); ?>" id="datetime" name="datetime" required/>
									</div>
									<div class="col-lg-2">
										<label>Injuries</label>
										<input type="text" class="form-control" id="injuries" name="injuries" required/>
									</div>
									<div class="col-lg-2">
										<label>Status</label>
