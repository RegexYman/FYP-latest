    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Shatin Overall
                            <div id="test"></div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <select class="form-control">
                                ...
                                <option>Only Map</option>
                                <option>Only Table</option>
                                <option>Only chart</option>
                            </select>
                        </div>
                        <div class="col-lg-3">
                            Display Area:
                                            ...
                                            foreach($cursor as $data){
                                                for($x=0;$x< count($condition);$x++){
                                                    for($z=0; $z<count($roadtype);$z++){
                                                        for($i = 0 ; $i < count($data['Speed_List']['ST_Region'][$condition[$x]][$roadtype[$z]]); $i++){
                                                            $res = findlocation($data['Speed_List']['ST_Region'][$condition[$x]][$roadtype[$z]][$i]['Link_ID']);
                                                            //echo "<tr><td>".$data['Speed_List']['ST_Region'][$condition[$x]][$roadtype[$z]][$i]['Traffic_Speed']."</td>";
                                                            echo "<td>".$condition[$x]."</td><td>".$data['Speed_List']['ST_Region'][$condition[$x]][$roadtype[$z]][$i]['Traffic_Speed']."</td>";
                                                            echo "<td>". $res['Street_Name']."</td>";
            ...
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> Sha Tin Overall
                        <div class="pull-right">
                        </div>
                    </div>
                    <!-- /.panel-heading -->
