    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Kowloon <div id="test"></div>
                                                ...
                                                for($x=0;$x< count($condition);$x++){
                                                    for($z=0; $z<count($roadtype);$z++){
                                                        for($i = 0 ; $i < count($data['Speed_List']['KL_Region'][$condition[$x]][$roadtype[$z]]); $i++){
                                                            $res = findlocation($data['Speed_List']['KL_Region'][$condition[$x]][$roadtype[$z]][$i]['Link_ID']);
                            
                                                            echo "<td>".$condition[$x]."</td>";
                                                        
                                                            echo "<td>".$data['Speed_List']['KL_Region'][$condition[$x]][$roadtype[$z]][$i]['Traffic_Speed']."</td>";
            ...
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Kowloon Traffic Condition
                        <div class="pull-right">
                        </div>
                    </div>
                    <!-- /.panel-heading -->
