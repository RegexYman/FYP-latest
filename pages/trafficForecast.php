    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Traffic jam forecast</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h5>Add Traffic jam forecast</h5>
                        </div>
                        <div class="panel-body">
							<form action="addTrafficForecast.php" method="POST" role="form">
								<div class="form-group">
									...
									<div class="form-group row">
										...
										<div class="col-lg-2">
											<label>Region</label>
											<input class="form-control" type="text" id="administrative_area_level_1" disabled="true" name="region" required>
                                        </div>
                                        <div class="col-lg-2">
									...
									<div class="form-group row">
										<div class="col-lg-2">
											...
											<input class="form-control" type="number" id="traffic_speed" min="0" name="traffic_speed" required>
										</div>
										<div class="col-lg-2">
											<label>Journey Time</label>
											<input class="form-control" type="number" id="journey_time" min="0" name="journey_time" required>
										</div>
										<div class="col-lg-2">
											<label>Detected Time</label>
											<input class="form-control" type="datetime-local" value="<?= date('Y-m-d').'T'.date('H:i'); ?>" id="detected_time" name="detected_time" required>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-lg-8">
...
foreach ($cursorHK as $c){
	...
	echo "<td>" . $c["Journey_Time"] . "</td>";
	echo "<td>" . $c["Detected_Time"] . "</td>";
	echo "<td>" . $c["Description"] . "</td>";
	echo "<td>" . "<a href='delTrafficForecast.php?id=" . $c["_id"] . "'>" . "<button type='button' class='btn btn-outline btn-danger'>Delete</button>" . "</a>" . "</td>";
	echo "</tr>";
}
?>
                                </tbody>
