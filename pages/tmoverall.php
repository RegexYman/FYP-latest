                                            ...
                                            foreach($cursor as $data){
                                                for($x=0;$x< count($condition);$x++){
                                                    for($z=0; $z<count($roadtype);$z++){
                                                        for($i = 0 ; $i < count($data['Speed_List']['TM_Region'][$condition[$x]][$roadtype[$z]]); $i++){
                                                            $res = findlocation($data['Speed_List']['TM_Region'][$condition[$x]][$roadtype[$z]][$i]['Link_ID']);
                                                            //echo "<tr><td>".$data['Speed_List']['ST_Region'][$condition[$x]][$roadtype[$z]][$i]['Traffic_Speed']."</td>";
                                                            echo "<td>".$condition[$x]."</td><td>".$data['Speed_List']['TM_Region'][$condition[$x]][$roadtype[$z]][$i]['Traffic_Speed']."</td>";
