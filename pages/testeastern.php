...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Hong Kong Island <div id="test"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            axios.post('http://218.255.16.240:3000/getGeoByLocation',
            
            {
                ...
                .then(function (response) {
                   ...
                   // 
                   var count = response.data[0].length ;
                    let { Average_Speed, Good_Speed, Poor_Speed } = response.data[0].Speed_List.HK_Region
                    ...
                    temp.forEach((e, i, a) => {
                        ...
                        temp1.forEach((ele, ind, arr) => {
                            ele.forEach((element, index, array) => {
                                ...
                                parta += `<tr><td>${e.name}</td><td>${Traffic_Speed}</td><td>${Link_ID}</td><td>${response.data[0].Capture_Date}</td></tr>`
                            })
                        })
                    })
                    parta += `       </tbody>
