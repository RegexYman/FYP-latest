...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tsuen Wan District
                            <div id="test"></div>
    ...
    ?>
                                                    ...
                                                    for($z=0; $z<count($roadtype);$z++){
                                                        for($i = 0 ; $i < count($data['Speed_List']['TM_Region'][$condition[$x]][$roadtype[$z]]); $i++){
                                                            ...
                                                            foreach($res as $wanchai){
                                                                if($wanchai['Link_ID']==$data['Speed_List']['TM_Region'][$condition[$x]][$roadtype[$z]][$i]['Link_ID']){
            ...
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> Tsuen Wan Traffic Condition
                        <div class="pull-right">
                        </div>
                    </div>
                    <!-- /.panel-heading -->
